        ...
        <button type="button" class="btn btn-guardarProductos" id="btnAdd">Guardar Cambios</button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button id="btnDetails" data-id="<?php echo $row['ServicioID']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Detalles" class="btn-detalles mx-2 border-0" disabled>
                        <i class="bi bi-eye-fill"></i>
                    </button>
                    <button id="btnUpdate" data-id="<?php echo $row['ServicioID']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar" class="btn-editar mx-2 border-0">
                        <i class="bi bi-pencil-fill"></i>
                    </button>
                    <button id="btnDelete" data-id="<?php echo $row['ServicioID']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar" class="btn-delete border-0">
